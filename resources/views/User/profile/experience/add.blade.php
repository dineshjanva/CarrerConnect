    ...
    <main class="edit-profile-container1">
        ...
        <form class="profile-form1" action="{{ route('addeduaction') }}" method="post">
            ...
            <div class="form-section1">
                @if (session('addexperience'))
                    <span>{{ session('addexperience') }}</span>
                @endif
                ...
                <div class="education-item1">
                    <div class="form-row1">
                        <div class="form-group">
                            ...
                            <input type="text" name="exp_company" class="form-control"
                                placeholder="e.g. Tech Solutions Inc." value="{{ old('exp_company') }}" required>
                            @error('exp_company') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="form-group">
                            <label>Location</label>
                            <input type="text" name="exp_location" class="form-control"
                                placeholder="e.g. San Francisco, CA" value="{{ old('exp_location') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="exp_description" class="form-control form-textarea"
                            placeholder="What did you work on?">{{ old('exp_description') }}</textarea>
