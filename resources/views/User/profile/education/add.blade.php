    ...
    <main class="edit-profile-container1">
        ...
        <form class="profile-form1" action="{{ route('addeduaction') }}" method="post">
            ...
            <div class="form-section1">
                @if (session('addeducation'))
                    <span>{{ session('addeducation') }}</span>
                @endif
                ...
                <div class="education-item1">
                    <div class="form-row1">
                        <div class="form-group">
                            ...
                            <input type="text" name="edu_institution" class="form-control"
                                placeholder="e.g. Stanford University" value="{{ old('edu_institution') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="edu_location" class="form-control" placeholder="e.g. Stanford, CA"
                                value="{{ old('edu_location') }}" required>
                    ...
                    <div class="form-row1">
                        <div class="form-group">
                            ...
                            <input type="text" name="edu_degree" class="form-control"
                                placeholder="e.g. Master of Computer Science" value="{{ old('edu_degree') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="edu_description" class="form-control form-textarea"
                            placeholder="Thesis or specialization" required>{{ old('edu_description') }}</textarea>
