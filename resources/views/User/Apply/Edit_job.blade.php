...
<body>
    ...
    <main class="post-job-container">
        ...
        <div class="post-job-form">
            <div class="form-container">
                <form id="jobPostForm" method="POST" action="{{ route('editpostdata',['id'=>$id]) }}" enctype="multipart/form-data">
                    @csrf
                    <!-- Job Details Section -->
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="jobTitle" name="job_title"
                                placeholder="e.g. Senior Frontend Developer" value="{{ $companyPostId->job_title }}"
                                required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="companyName" name="company_name" placeholder="e.g. TechCorp Inc."
                                value="{{ $companyPostId->company_name }}" required>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select id="jobType" name="job_type" required>
                                    ...
                                    <option value="full-time" {{ old('job_type', $companyPostId->job_type) == 'full-time' ? 'selected' : '' }}>Full-time</option>
                                    <option value="part-time" {{ old('job_type', $companyPostId->job_type) == 'part-time' ? 'selected' : '' }}>Part-time</option>
                                    <option value="contract" {{ old('job_type', $companyPostId->job_type) == 'contract' ? 'selected' : '' }}>Contract</option>
                                    <option value="internship" {{ old('job_type', $companyPostId->job_type) == 'internship' ? 'selected' : '' }}>Internship</option>
                                    <option value="remote" {{ old('job_type', $companyPostId->job_type) == 'remote' ? 'selected' : '' }}>Remote</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select id="experienceLevel" name="experience_level" required>
                                    ...
                                    <option value="entry" {{ old('experience_level', $companyPostId->experience_level) == 'entry' ? 'selected' : '' }}>Entry Level
                                    </option>
                                    <option value="mid" {{ old('experience_level', $companyPostId->experience_level) == 'mid' ? 'selected' : '' }}>Mid Level</option>
                                    <option value="senior" {{ old('experience_level', $companyPostId->experience_level) == 'senior' ? 'selected' : '' }}>Senior Level
                                    </option>
                                    <option value="executive" {{ old('experience_level', $companyPostId->experience_level) == 'executive' ? 'selected' : '' }}>Executive
                                    </option>
                                </select>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="location" name="location"
                                    ...
                                    value="{{ $companyPostId->location }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="salaryRange" name="salary_range" placeholder="e.g. 100000-130000"
                                    value="{{$companyPostId->salary_range }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="applicationUrl" name="application_url"
                                ...
                                value="{{ $companyPostId->company_website  }}" required>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="jobDescription" name="job_description"
                                ...
                                required>{{ $companyPostId->job_description }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="responsibilities" name="responsibilities"
                                ...
                                required>{{ $companyPostId->responsibilities }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="requirements" name="requirements"
                                ...
                                required>{{ $companyPostId->requirements }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="benefits" name="benefits"
                                placeholder="List any benefits or perks offered...">{{ $companyPostId->benefits }}</textarea>
    ...
    value="{{ is_array(json_decode($companyPostId->required_skills)) ? implode(', ', json_decode($companyPostId->required_skills)) : '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox-group">
                                <input type="hidden" name="bachelor_degree" value="0">
<input type="checkbox" id="bachelorDegree" name="bachelor_degree" value="1"
    {{ old('bachelor_degree', $companyPostId->bachelor_degree) == '1' ? 'checked' : '' }}>
<label for="bachelorDegree">Bachelor's Degree</label>
    ...
    {{ old('portfolio_required', $companyPostId->portfolio_required) == '1' ? 'checked' : '' }}>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="aboutCompany" name="about_company"
                                ...
                                required>{{ $companyPostId->about_company }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="companyWebsite" name="company_website"
                                placeholder="https://yourcompany.com" value="{{ $companyPostId->company_website }}">
                            @error('company_website') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>

@if($companyPostId->company_logo)
    <div class="mb-2">
        <img src="{{ asset('storage/' . $companyPostId->company_logo) }}" alt="Current Image" width="120">
    </div>
@endif
                        <div class="form-group">
                            <label for="companyLogo">Company Logo</label>
                            <input type="file" id="companyLogo" name="company_logo" accept="image/*"
                                value="{{ $companyPostId->company_logo }}">
